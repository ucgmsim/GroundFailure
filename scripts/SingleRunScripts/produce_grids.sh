...
#mkdir /home/lukelongworth/Data/grids/$dataset
...
do
  ...
  do
    ...
    cp $run_dir/$run_name/GM/Sim/Data/$run_name/$realisation/grid.xml /home/lukelongworth/Data/grids/$dataset/grid_$realisation.xml
  done
done
