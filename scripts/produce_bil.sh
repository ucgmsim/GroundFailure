...
do
  ...
  do
    ...
    python3 /usr/bin/gfail /home/nesi00213/groundfailure/config/jessee_2017_susceptibility.ini $realisation_path/grid.xml --set-bounds 'zoom, pgv, 0' --hdf5 -o /home/lukelongworth/BILs/Landslide/ -c /home/nesi00213/groundfailure/config -d /home/nesi00213/groundfailure/landslide_model --gis
  done
done
